...
suite "Binary (CBOR) serialization of complex fields should":
  ...
  test "round-trip a fixed size array field":
    ...
    let data = world.serializeToBinary((Transform,))
    var restored = deserializeFromBinary(data, (Transform,))
...
#
  test "round-trip a nested object field":
    ...
    let data = world.serializeToBinary((Shape,))
    var restored = deserializeFromBinary(data, (Shape,))
  ...
  test "round-trip a nested object field holding a fixed size array":
    ...
    let data = world.serializeToBinary((Placement,))
